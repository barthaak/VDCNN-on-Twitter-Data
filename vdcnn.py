...
from keras.layers import Input, Embedding, Conv1D, BatchNormalization, Activation, Add, MaxPooling1D, MaxPooling2D, Dense, Flatten,Dropout
...
def VDCNN(num_classes, depth=9, sequence_length=1024, embedding_dim=16, 
          shortcut=False, pool_type='max', sorted=True, use_bias=False, dropout=False, input_tensor=None):
    if depth == 9:
